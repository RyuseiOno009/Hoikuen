...
public class main1 : MonoBehaviour
{
    ...
    //2Fの座標
    float[] zahyou5 = new float[3] { 97.062f, -0.002f, -2.831f };
    float[] zahyou6= new float[3] { 102.371f, -0.002f, -2.831f };
    float[] zahyou7 = new float[3] { 102.371f, -0.002f, 2.716f };
    float[] zahyou8 = new float[3] { 97.062f, -0.002f, 2.716f };
    ...
    //スレッドを作成する
    {
        ...
        string foldersStr = NanoGW.GetFolders();

        int maxCount = 100;
        while (true)
        {
            int pi = foldersStr.IndexOf("\"");

            if (pi < 0) break;

            foldersStr = foldersStr.Substring(pi + 1);
            pi = foldersStr.IndexOf("\"");

            string folderName = foldersStr.Substring(0, pi - 1);
    ...
    void addAnnotation(float x,float y,int floorNum,string imgbase64)
    {
        ...
        if (floorNum == 0)
        {
            v1 = new Vector3(zahyou3[0], zahyou3[1], zahyou3[2]);
            v2 = new Vector3(zahyou4[0], zahyou4[1], zahyou4[2]);
            v3 = new Vector3(zahyou1[0], zahyou1[1], zahyou1[2]);
        } else
        {
            v1 = new Vector3(zahyou7[0], zahyou3[1], zahyou3[2]);
            v2 = new Vector3(zahyou8[0], zahyou4[1], zahyou4[2]);
            v3 = new Vector3(zahyou5[0], zahyou1[1], zahyou1[2]);
        }
        ...
        // Draw lines
        GameObject bObj = obj;// GameObject.Find("building");
        //倉木永田のオブジェクト情報の読み取り
